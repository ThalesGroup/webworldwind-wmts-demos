...
requirejs(['../src/WorldWind',
    ...
    function (ww,
        ...
        var layers = [
            ...
            {layer: new WorldWind.BMNGOneImageLayer(), enabled: true},        {layer: new WorldWind.BMNGLandsatLayer(), enabled: false},
        ...
        var multiplicator = 200;
        // For each placemark image, create a placemark with a label.
        for (var i = 0, len = images.length * multiplicator; i < len; i++) {
            // Create the placemark and its label.
            placemark = new WorldWind.Placemark(new WorldWind.Position(latitude - i / multiplicator, longitude + i % multiplicator, 1e2), true, null);
            ...
            placemarkAttributes.imageSource = pinLibrary + images[i % 21];
